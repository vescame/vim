...
"
" Nmap <silent> <BS> [Cancel highlighting] :call HLNextOff() <BAR>\
" :nohlsearch<CR>
"
" If using documap.vim and either visualguide.vim or visualsmartia.vim
"
" Nmap <silent> <BS> [Cancel highlighting] :call HLNextOff() <BAR> :nohlsearch\
" <BAR> :call VG_Show_CursorColumn('off')<CR> 
